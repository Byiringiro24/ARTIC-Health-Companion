D:\Projectts 2026\SANO IRENE\New folder (2)\backend\.env

DATABASE_URL=postgresql://artic_user:Artic$2026@localhost:5432/fleet_management?schema=public&sslmode=disable
REDIS_URL=redis://localhost:6379
JWT_SECRET=artic-super-secret-jwt-key-min-32-chars-here
JWT_REFRESH_SECRET=artic-refresh-secret-min-32-chars-here
JWT_EXPIRES_IN=15m
...
D:\Projectts 2026\SANO IRENE\New folder (2)\backend\.env.server


DATABASE_URL=postgresql://Byiringiro:Artic$2026@localhost:5432/fleet_management?schema=public&sslmode=disable
REDIS_URL=redis://localhost:6379
JWT_SECRET=artic-production-jwt-secret-min-32-chars-2026
...
D:\Projectts 2026\SANO IRENE\New folder (2)\docker-compose.yml
...
services:
  postgres:
    ...
    healthcheck:
      test: ['CMD-SHELL', 'pg_isready -U artic_user -d fleet_management']
      interval: 10s
      timeout: 5s
      retries: 5
  ...
  backend:
    ...
    ports:
      ...
      - '1883:1883'   # MQTT (ESP32 devices connect here)
    environment:
      DATABASE_URL: "postgresql://artic_user:${POSTGRES_PASSWORD}@postgres:5432/fleet_management?schema=public&sslmode=disable"
...
D:\Projectts 2026\SANO IRENE\New folder (2)\Server Deployment Guide.md
